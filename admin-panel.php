                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="cashier_username" name="cashier_username" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cashier_password" class="form-label">Password</label>
                            <input type="password" class="form-control" id="cashier_password" name="cashier_password" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cashier_fname" class="form-label">First Name</label>
                            <input type="text" class="form-control" id="cashier_fname" name="cashier_fname" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cashier_lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="cashier_lname" name="cashier_lname" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="cashier_contact" class="form-label">Contact</label>
                            <input type="text" class="form-control" id="cashier_contact" name="cashier_contact" required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="edit_cashier_fname" class="form-label">First Name</label>
                            <input type="text" class="form-control" id="edit_cashier_fname" name="cashier_fname" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_cashier_lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="edit_cashier_lname" name="cashier_lname" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_cashier_email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="edit_cashier_email" name="cashier_email" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="edit_cashier_contact" class="form-label">Contact</label>
                            <input type="text" class="form-control" id="edit_cashier_contact" name="cashier_contact" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="edit_cashier_status" class="form-label">Status</label>
                            <select class="form-control" id="edit_cashier_status" name="cashier_status" required>
                                <option value="Active">Active</option>
                                <option value="Inactive">Inactive</option>
                            </select>
                        </div>
...
<div class="tab-pane fade" id="cashier-management" role="tabpanel" aria-labelledby="cashier-management-tab">
    <div class="glass-card p-4">
        <h4 class="text-dark mb-4 d-flex justify-content-between align-items-center">
            <span><i class="fas fa-cash-register me-2"></i>Cashier Management</span>
            <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addCashierModal">
        ...
        <div class="table-responsive">
            <table class="table table-glass">
                ...
                <tbody>
                    <?php
                    $cashier_query = mysqli_query($con, "SELECT * FROM cashiertb ORDER BY id DESC");
                    while ($cashier = mysqli_fetch_array($cashier_query)) {
                        echo '<tr>
                            <td>' . $cashier['id'] . '</td>
                            <td>' . $cashier['fname'] . '</td>
                            <td>' . $cashier['lname'] . '</td>
                            ...
                            <td>' . $cashier['created_by'] . '</td>
                            <td>
                                <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editCashierModal" onclick="editCashier(\'' . $cashier['id'] . '\', \'' . $cashier['fname'] . '\', \'' . $cashier['lname'] . '\', \'' . $cashier['email'] . '\', \'' . $cashier['contact'] . '\', \'' . $cashier['status'] . '\')">Edit</button>
                                <form method="POST" style="display:inline;">
                                    <input type="hidden" name="delete_cashier_id" value="' . $cashier['id'] . '">
                                    <button type="submit" name="delete_cashier" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure you want to delete this cashier?\')">Delete</button>
                                </form>
                            </td>
                        </tr>';
                    }
...
if (isset($_POST['add_cashier'])) {
    ...
    $password = password_hash($_POST['cashier_password'], PASSWORD_DEFAULT);
    $fname = $_POST['cashier_fname'];
    $lname = $_POST['cashier_lname'];
    $email = $_POST['cashier_email'];
    $contact = $_POST['cashier_contact'];

    $insert_query = "INSERT INTO cashiertb (username, password, fname, lname, email, contact, created_by) VALUES ('$username', '$password', '$fname', '$lname', '$email', '$contact', '$admin_username')";
    if (mysqli_query($con, $insert_query)) {
        echo "<script>alert('Cashier added successfully!');</script>";
    } else {
        echo "<script>alert('Error adding cashier.');</script>";
    }
}
...
if (isset($_POST['update_cashier'])) {
    ...
    $email = $_POST['cashier_email'];
    $contact = $_POST['cashier_contact'];
    $status = $_POST['cashier_status'];

    $update_query = "UPDATE cashiertb SET fname='$fname', lname='$lname', email='$email', contact='$contact', status='$status' WHERE id='$id'";
    if (mysqli_query($con, $update_query)) {
        echo "<script>alert('Cashier updated successfully!');</script>";
    }
}

if (isset($_POST['delete_cashier'])) {
    $id = $_POST['delete_cashier_id'];

    $delete_query = "DELETE FROM cashiertb WHERE id='$id'";
    if (mysqli_query($con, $delete_query)) {
        echo "<script>alert('Cashier deleted successfully!');</script>";
    }
}
...
<<<<<<< HEAD
    ...
    function editCashier(id, fname, lname, email, contact, status) {
        ...
        document.getElementById('edit_cashier_fname').value = fname;
        document.getElementById('edit_cashier_lname').value = lname;
        document.getElementById('edit_cashier_email').value = email;
